...
<body>
 ...
 <header>
  ...
  <section style="background-image:url(<?php echo base_url();?>assets/images/bg/imageBg_home.jpeg);" class="breadcrumbs">
    <div class="container">
      <div class="text-left breadcrumbs-item"><a href="<?php echo site_url('Home');?>">Home</a><i>/</i><a href="#">Paket</a>
        <h2><span>Paket</span> Destinasi Wisata</h2>
      </div>
    </div>
  </section>
  <!-- ! breadcrumbs end-->
  ...
  <div class="container page">
    <div class="row">
      <div class="col-md-8">
        ...
        <h2 class="title-section"><span>Paket</span> travelling</h2>
        <div class="cws_divider mb-25 mt-5"></div>
        <p>Berikut adalah paket travelling rekomendasi kami.</p>
      </div>
      <div class="col-md-4"><i class="flaticon-suntour-fireworks title-icon"></i></div>
    </div>
