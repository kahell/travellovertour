                                    ...
                                    <tbody>
                                        ...
                                        if (empty($slider)) {
                                            ...
                                            <tr>
                                               ...
                                               <td>Rp. <?php echo number_format((Double)$row->harga_paket);?></td>
                                               <td>
                                                <?php
                                                //echo $sumSlider;
                                                if ($sumSlider >= 5) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a id="btnEdit_testi" data-toggle="modal" data-target="#myModal" class="btn btn-info btnEdit_testi" href="#" ><i class="fa fa-edit"></i>
                                                ...
                                                <input type="hidden" name="pictBg_testi" id="pictBg_testi" value="<?php echo $row->pictBg_testi?>">
          ...
          "autoWidth": true
            ...
            $('.btnEdit_testi').each(function(){
                $(this).click(function(event){
                    ...
                    var pictBg_testi = $(this).find('#pictBg_testi').val();
                    ...
                    $('#mpictCadanganBg_testi').val(pictBg_testi);
            ...
            $('#saveChange').click(function(event){
                ...
                formData.append('pictBg_testi', $("#mpictCadanganBg_testi").val());
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="mpictCadanganBg_testi" name="mpictCadanganBg_testi" class="form-control" value="">
